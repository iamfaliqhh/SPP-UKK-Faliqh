                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ url('dashboard/pembayaran') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="select2 custom-select @error('nisn') is-invalid @enderror, form-control"
                                id="nisn" name="nisn">
                                <option disabled selected option value="">Silahkan Pilih</option>
                                @foreach ($siswa as $s)
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ url('dashboard/laporan/create') }}" class="btn btn-primary btn-rounded"
                        style="position:relative; left:1030px;">Buat Laporan</a>
                    <br>
                    &nbsp;
                    &nbsp;
