                            ...
                            <tbody>
                                ...
                                @foreach ($mails as $mail)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('dashboard/mail/view', $mail->id) }}"
                                            ...
                                            <div class="hide-menu">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actiondd">
                                                    <a class="dropdown-item"
                                                        href="{{ url('dashboard/mail', $mail->id) }}"><i
                    ...
                    @if ($mails->lastPage() != 1)
                        <div class="btn-group float-right">
                            ...
                            @for ($i = 1; $i <= $mails->lastPage(); $i++)
                                <a class="btn btn-success {{ $i == $mails->currentPage() ? 'active' : '' }}"
                                    href="{{ $mails->url($i) }}">{{ $i }}</a>
                            @endfor
